 ...
 * 
 */
public class TextBoxInfo extends TextFieldInfo<TextBox> {
     ...
     */
    public TextBoxInfo(TemplateTopPanel panel, Map<String, String> attributes) {
